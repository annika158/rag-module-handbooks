...
###### RAG-SYSTEM FOR MODULE HANDBOOKS - without chunk modifications and without metadata filtering ######
...
def main():
    ...
    for example in examples:
        ...
        result_file = f"result_comparison/no_modifications_retrieved_chunks/question{i}.txt"
        ...
        def format_splits(relevant_splits):
            ...
            with open(result_file, "w") as f:
                f.write(f"No modifications - Question: {question} \n\n")
                f.write("===== Metadata =====\n\n")
