...
result_file = f"result_comparison/rag_metadata_filter_source_module_retrieved_chunks/question{i+1}.txt"
...
def save_retrieved_chunks(relevant_splits):
    ...
    with open(result_file, "a") as f:
        f.write(f"Metadata filter (source and module): \n\n")
        f.write("===== Metadata =====\n\n")
