...
###### RAG-SYSTEM FOR MODULE HANDBOOKS WITH METADATA FILTERING and using Embeddings to identify the right module handbook ######
...
# In this file, the retriever is used to identify the source of the module handbook
...
def build_vectorstore(metadata_text_file="module_handbooks_economics_metadata.txt", persist_directory_sources_metadata="vectorstores", collection_name_sources_metadata="sources_metadata"):
    """
    ...
    Chroma.from_documents(
        ...
        persist_directory=persist_directory_sources_metadata,
        collection_name=collection_name_sources_metadata
    ) 
    print("Saved to vectorstore.")

def identify_source_retriever(extracted_metadata, persist_directory_sources_metadata="vectorstores", collection_name_sources_metadata="sources_metadata"):
    """
...
def generate_filter(question):
    ...
    source = identify_source_retriever(extracted_metadata)
...
def main():
    ...
    # Uncomment the following lines when running the first time to save all sources in a text file 
    ...
    # TODO: Uncomment the following line when running the first time to build the vectorstore
    # build_vectorstore()
